...
fn dead_server_cli_reports_one_session_aware_json_line() {
    ...
    let stale = Command::new(env!("CARGO_BIN_EXE_hpp"))
...
fn integration_commands_run_locally_when_server_is_missing() {
    ...
    let workspace_list = Command::new(env!("CARGO_BIN_EXE_hpp"))
        .args(["workspace", "list"])
    ...
    let integration_install = Command::new(env!("CARGO_BIN_EXE_hpp"))
    ...
    let integration_status = Command::new(env!("CARGO_BIN_EXE_hpp"))
    ...
    let integration_uninstall = Command::new(env!("CARGO_BIN_EXE_hpp"))
...
fn integration_status_outdated_only_prints_action_for_legacy_install() {
    ...
    let output = Command::new(env!("CARGO_BIN_EXE_hpp"))
